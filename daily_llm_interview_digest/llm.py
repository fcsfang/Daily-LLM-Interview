...
## 5. 今日参考资料
必须列出本日报实际引用过的资料编号，格式如下：
- [1] 标题 - 链接 - 来源类型 - 可信度说明
- [2] 标题 - 链接 - 来源类型 - 可信度说明

引用要求：
1. 日报正文中出现的所有“参考资料 [x]”都必须能在本节找到对应编号。
2. 技术博客精读中的“链接”必须是以 http:// 或 https:// 开头的真实 URL；如果无法确认真实 URL，写“链接：需进一步验证”，不要写“参考资料 [x] 中引用的链接”这类不可点击描述。
3. 来源类型只能写：官方文档 / 论文 / 技术博客 / 岗位 JD / 面经或社媒 / 其他。
4. 对个人博客、论坛、LinkedIn、面经搬运等来源，可信度说明中必须写“需进一步验证”。
5. 不要使用无法在当天搜索资料中对应上的资料编号。
...
- [1] 经典高频题补充 - 需进一步验证 - 其他 - 今日未配置模型 API 或搜索资料有限，所有来源相关表述需进一步验证
"""
