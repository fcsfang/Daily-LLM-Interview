...
- 5 个必背问答卡片
- 1 道大模型理论追问题、1 个项目表达任务
- 最近 7 天历史去重，避免连续推送高度相似的题目和任务
- 每周主题轮换，覆盖 RAG、Agent、LoRA、评测、部署、应用工程和综合复盘
- 技术文章按工程实践、理论/论文、岗位 JD 或面经做用途分布
...
历史索引会写入 `outputs/index.json`，用于下一次生成时减少重复内容。
